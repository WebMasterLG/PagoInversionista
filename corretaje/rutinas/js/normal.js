...
var gBegin=[2000,1,1];	// static Range begin from [Year,Month,Date]
...
var gsBottom="<A href='javascript:void(0)' class='dia_hoy' onclick='var tmp=gCurMonth;gCurMonth=gToday;if(!NN4)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2])){gCurMonth=tmp;alert(\"Tu no puedes Seleccionar este dia!\")}return false;' onmouseover='return true;' title='Hoy'>"+gToday[2]+" "+gMonths[gToday[1]-1]+" "+gToday[0]+"</A>";	// the expression of Today-portion at the bottom.
...
var gsCalTable="border=0 cellpadding=1 cellspacing=1";	// properties of the calendar inside <table> tag
...
var gcBG="";	// default background color of the cells. Use "" for transparent!!!
var gcCalBG="#000000";	// background color of the calendar
var gcFrame="#eeefff";	// frame color
var gcSat="darkcyan";	// Saturday color
var gcSun="red";	// Sunday color
var gcWorkday="black";	// Workday color
var gcOtherDay="ccc";	// the day color of other months
var gcToggle="#FFFF66";	// highlight color of the focused cell
